...
-- Test appointments (with doctor_id: 2=Др. Смит, 3=Др. Джонс, 4=Др. Уилсон)
INSERT INTO appointments (patient_id, service_id, doctor_id, appointment_date, status, price, duration_minutes, notes) VALUES
(1, 1, 2, '2024-12-20 10:00:00', 'scheduled', 5000.00, 30, 'Первичная консультация'),
(2, 12, 3, '2024-12-20 14:00:00', 'scheduled', 15000.00, 60, 'Профессиональная чистка'),
(1, 4, 2, '2024-12-25 11:00:00', 'scheduled', 15000.00, 60, 'Лечение кариеса на 6-м зубе'),
(3, 1, 4, '2024-12-21 09:00:00', 'scheduled', 5000.00, 30, 'Консультация по протезированию'),
(1, 7, 3, '2024-12-26 15:00:00', 'scheduled', 35000.00, 120, 'Лечение пульпита 7-го зуба'),
(2, 10, 2, '2024-12-22 11:00:00', 'scheduled', 20000.00, 90, 'Удаление зуба мудрости'),
(3, 15, 4, '2024-12-23 10:00:00', 'scheduled', 120000.00, 120, 'Установка коронки')
ON CONFLICT DO NOTHING;
